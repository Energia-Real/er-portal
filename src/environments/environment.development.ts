export const environment = {
  ...
  API_URL_PERFORMANCE_V2: 'https://er-portal-gateway.azurewebsites.net/dev/api/v1',
  ...
  API_URL_EQUIPMENT_HUAWEI_V1:
    'https://er-equipment-monitoring-ms.azurewebsites.net/api/huawei/v1',
  API_URL_ENERGY_PERFORMANCE_V1: 'https://er-performance-api-dev.azurewebsites.net/api/v1',
