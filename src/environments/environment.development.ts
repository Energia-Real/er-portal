export const environment = {
  production: false,
  API_URL_PERFORMANCE : "https://er-performance-api.azurewebsites.net/dev/api/v1",
  API_URL_PERFORMANCE_V2: 'https://er-performance-api-dev.azurewebsites.net/dev/api/v1',
